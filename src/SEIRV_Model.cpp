...
public:
  ...
  static shared_state build_shared(cpp11::list parameters) {
    ...
    return shared_state{dim, offset, time_inc, t_incubation, t_latent, t_infectious, FOI_spillover, R0, N_age, vaccine_efficacy, year0, n_years, Pmin, FOI_max, rate1, rate2, beta, vacc_rate_daily, S_0, E_0, I_0, R_0, V_0, dP1_all, dP2_all};
  }
