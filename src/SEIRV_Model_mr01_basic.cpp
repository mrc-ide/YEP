...
// [[dust2::class(SEIRV_Model_mr01_basic)]]
...
class SEIRV_Model_mr01_basic {
public:
  SEIRV_Model_mr01_basic() = delete;
...
SEXP dust2_system_SEIRV_Model_mr01_basic_alloc(cpp11::list r_pars, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_seed, cpp11::sexp r_deterministic, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_alloc<SEIRV_Model_mr01_basic>(r_pars, r_time, r_time_control, r_n_particles, r_n_groups, r_seed, r_deterministic, r_n_threads);
}
[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_run_to_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_run_to_time<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, r_time);
}
...
SEXP dust2_system_SEIRV_Model_mr01_basic_state(cpp11::sexp ptr, cpp11::sexp r_index_state, cpp11::sexp r_index_particle, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_state<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, r_index_state, r_index_particle, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_time(cpp11::sexp ptr) {
  return dust2::r::dust2_system_time<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_set_state_initial(cpp11::sexp ptr) {
  return dust2::r::dust2_system_set_state_initial<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_set_state(cpp11::sexp ptr, cpp11::list r_state) {
  return dust2::r::dust2_system_set_state<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, r_state);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_reorder(cpp11::sexp ptr, cpp11::integers r_index) {
  return dust2::r::dust2_system_reorder<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, r_index);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_system_rng_state<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_system_set_rng_state<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, r_rng_state);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_set_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_set_time<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, r_time);
}

[[cpp11::register]]
SEXP dust2_system_SEIRV_Model_mr01_basic_update_pars(cpp11::sexp ptr, cpp11::list pars) {
  return dust2::r::dust2_system_update_pars<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, pars);
}
...
SEXP dust2_system_SEIRV_Model_mr01_basic_simulate(cpp11::sexp ptr, cpp11::sexp r_times, cpp11::sexp r_index_state, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_simulate<dust2::dust_discrete<SEIRV_Model_mr01_basic>>(ptr, r_times, r_index_state, preserve_particle_dimension, preserve_group_dimension);
}
