...
#' @param add_values List containing values of additional inputs or NULL to indicate they are being varied as parameters:
...
#' @export
#'
mcmc_checks <- function(log_params_ini=c(),n_regions=1,type=NULL,prior_settings=list(type="zero"),enviro_data=NULL,
