...
#'                  vaccine_efficacy=NULL,p_severe_inf=0.12,p_death_severe_inf=0.39,
#'                  p_rep_severe_af=NULL,p_rep_death_af=NULL,p_rep_severe_sa=NULL,p_rep_death_sa=NULL,
...
#'   if(is.null(p_rep_severe_af)==TRUE){extra_params=append(extra_params,"p_rep_severe_af")}
#'   if(is.null(p_rep_death_af)==TRUE){extra_params=append(extra_params,"p_rep_death_af")}
#'   if(is.null(p_rep_severe_sa)==TRUE){extra_params=append(extra_params,"p_rep_severe_sa")}
#'   if(is.null(p_rep_death_sa)==TRUE){extra_params=append(extra_params,"p_rep_death_sa")}
...
#'               p_rep_severe_af=p_rep_severe_af,p_rep_death_af=p_rep_death_af,
#'               p_rep_severe_sa=p_rep_severe_sa,p_rep_death_sa=p_rep_death_sa,
#'               m_FOI_Brazil=m_FOI_Brazil,deterministic=deterministic,
...
#'   prior_report=0
#'   if(is.numeric(consts$p_rep_severe_af)==FALSE){
#'     p_rep_severe_af=as.numeric(exp(log_params_prop[names(log_params_prop)=="p_rep_severe_af"]))
#'     if(p_rep_severe_af<=0.0 || p_rep_severe_af>1.0){prior_report=-Inf}
#'   } else {
#'     p_rep_severe_af=consts$p_rep_severe_af
#'   }
#'   if(is.numeric(consts$p_rep_severe_sa)==FALSE){
#'     p_rep_severe_sa=as.numeric(exp(log_params_prop[names(log_params_prop)=="p_rep_severe_sa"]))
#'     if(p_rep_severe_sa<=0.0 || p_rep_severe_sa>1.0){prior_report=-Inf}
#'   } else {
#'     p_rep_severe_sa=consts$p_rep_severe_sa
#'   }
#'   if(is.numeric(consts$p_rep_death_af)==FALSE){
#'     p_rep_death_af=as.numeric(exp(log_params_prop[names(log_params_prop)=="p_rep_death_af"]))
#'     if(p_rep_death_af<=0.0 || p_rep_death_af>1.0){prior_report=-Inf}
#'   } else {
#'     p_rep_death_af=consts$p_rep_death_af
#'   }
#'   if(is.numeric(consts$p_rep_death_sa)==FALSE){
#'     p_rep_death_sa=as.numeric(exp(log_params_prop[names(log_params_prop)=="p_rep_death_sa"]))
#'     if(p_rep_death_sa<=0.0 || p_rep_death_sa>1.0){prior_report=-Inf}
#'   } else {
#'     p_rep_death_sa=consts$p_rep_death_sa
#'   }
#'
...
#'   prior_prop=prior_vacc+prior_report+FOI_R0_data$prior +
#'     sum(dnorm(log(c(p_rep_severe_af,p_rep_death_af,p_rep_severe_sa,p_rep_death_sa)),
...
#'                                 consts$p_death_severe_inf,p_rep_severe_af,p_rep_death_af,p_rep_severe_sa,p_rep_death_sa,consts$mode_start,start_SEIRV=NULL,consts$dt,
...
#'                             p_rep_severe_af=NULL,p_rep_death_af=NULL,p_rep_severe_sa=NULL,p_rep_death_sa=NULL,
#'                             m_FOI_Brazil=1.0,deterministic=TRUE,mode_parallel="none",cluster=NULL){
#'
