...
# @param Sart_SEIRV Optional list of initial SEIRV population values by region, year and age;
# if NULL, calculated within function
...
Generate_VIMC_Burden_Dataset <- function(FOI_values = c(),R0_values = c(),input_data = list(),template = NULL,
                                         ...
                                         #use_node_cluster = FALSE,
                                         mode_div = "serial",
                                         n_nodes = 1, seed = NULL, xref = NULL){
  ...
  if(mode_div=="parallel"){#if(!use_node_cluster){
    model_output = Model_Run(FOI_spillover = FOI_values, R0 = R0_values,
                             ...
                             time_inc = time_inc, mode_out = 4, mode_start = mode_start,
                             start_SEIRV = NULL, #TBC
                             mode_time = mode_time, n_particles = n_reps, n_threads = n_reps,
    ...
    if(mode_div=="cluster"){
      ...
      model_output_all = clusterMap(cl = cluster,fun = Model_Run, FOI_spillover = FOI_subsets, R0 = R0_subsets,
                                    ...
                                    MoreArgs = list(year0 = input_data$years_labels[1],
                                                    ...
                                                    mode_out = 4, mode_start = mode_start, start_SEIRV = NULL, #TBC
  ...
  for(n_region in 1:n_regions){
    ...
    if(mode_div=="serial"){
      ...
      if(mode_div=="cluster"){#if(use_node_cluster){{
