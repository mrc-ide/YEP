---
title: "Worked Example 2 - Running Model For Multiple Parameter Sets"
...
We load input data in the appropriate format as in [Worked Example 1 - Single Model Run](https://mrc-ide.github.io/YEP/articles/BWorkedExampleAModelRun.html). Here we want to run the model for all 25 regions listed.
