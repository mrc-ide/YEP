...
This vignette demonstrates how the output of the dynamic yellow fever model functions (see [Worked Example 1 - Single Model Run](https://mrc-ide.github.io/YellowFeverDynamics/articles/BWorkedExampleAModelRun.html)) can be processed to produce epidemiological data similar to that produced by real-world surveillance. Two types of data are discussed here:
